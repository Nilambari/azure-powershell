    ...
    try 
     {
      ...
      Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].ResourceGroupName $actual.ResourceGroupName	
      Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].SALifeTimeSeconds $actual.SALifeTimeSeconds
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].SADataSizeKilobytes $actual.SADataSizeKilobytes
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].IpsecEncryption $actual.IpsecEncryption
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].IpsecIntegrity $actual.IpsecIntegrity
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].IkeEncryption $actual.IkeEncryption
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].IkeIntegrity $actual.IkeIntegrity
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].DhGroup $actual.DhGroup
	  Assert-AreEqual $expected.VpnClientConfiguration.VpnClientIpsecPolicies[0].PfsGroup $actual.PfsGroup
      #Assert-AreEqual "Vpn" $expected.GatewayType
      #Assert-AreEqual "RouteBased" $expected.VpnType
	  ...
	  Assert-AreEqual $vpnclientipsecpolicy2.SALifeTimeSeconds $gateway.SALifeTimeSeconds
	  Assert-AreEqual $vpnclientipsecpolicy2.SADataSizeKilobytes $gateway.SADataSizeKilobytes
	  Assert-AreEqual $vpnclientipsecpolicy2.IpsecEncryption $gateway.IpsecEncryption
	  Assert-AreEqual $vpnclientipsecpolicy2.IpsecIntegrity $gateway.IpsecIntegrity
	  Assert-AreEqual $vpnclientipsecpolicy2.IkeEncryption $gateway.IkeEncryption
	  Assert-AreEqual $vpnclientipsecpolicy2.IkeIntegrity $gateway.IkeIntegrity
	  Assert-AreEqual $vpnclientipsecpolicy2.DhGroup $gateway.DhGroup
	  Assert-AreEqual $vpnclientipsecpolicy2.PfsGroup $gateway.PfsGroup
	  ...
	  $setvpnIpsecParams = Set-AzureRmVpnClientIpsecParameters -VirtualNetworkGatewayName VNet2GW -ResourceGroupName TestRG1 -VpnClientIPsecParameters $vpnclientipsecparams1
	  Assert-AreEqual $vpnclientipsecparams1.SALifeTimeSeconds $setvpnIpsecParams.SALifeTimeSeconds
	  Assert-AreEqual $vpnclientipsecparams1.SADataSizeKilobytes $setvpnIpsecParams.SADataSizeKilobytes
	  Assert-AreEqual $vpnclientipsecparams1.IpsecEncryption $setvpnIpsecParams.IpsecEncryption
	  Assert-AreEqual $vpnclientipsecparams1.IpsecIntegrity $setvpnIpsecParams.IpsecIntegrity
	  Assert-AreEqual $vpnclientipsecparams1.IkeEncryption $setvpnIpsecParams.IkeEncryption
	  Assert-AreEqual $vpnclientipsecparams1.IkeIntegrity $setvpnIpsecParams.IkeIntegrity
	  Assert-AreEqual $vpnclientipsecparams1.DhGroup $setvpnIpsecParams.DhGroup
	  Assert-AreEqual $vpnclientipsecparams1.PfsGroup $setvpnIpsecParams.PfsGroup

	  # Get P2S VPNClient Configuration :- set custom Ipsec policy usin new API:- Get-AzureRmVpnClientIpsecParameters
