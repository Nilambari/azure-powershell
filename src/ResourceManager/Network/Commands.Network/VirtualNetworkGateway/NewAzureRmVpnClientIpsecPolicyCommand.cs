...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public class NewAzureRmVpnClientIpsecPolicyCommand : NetworkBaseCmdlet
    {
        ...
        public override void Execute()
        {
            ...
            // default SA values
            vpnclientIpsecPolicy.SALifeTimeSeconds = (!this.MyInvocation.BoundParameters.ContainsKey("SALifeTimeSeconds")) ? 27000 : this.SALifeTimeSeconds;
            vpnclientIpsecPolicy.SADataSizeKilobytes = (!this.MyInvocation.BoundParameters.ContainsKey("SADataSizeKilobytes")) ? 102400000 : this.SADataSizeKilobytes;
            ...
            vpnclientIpsecPolicy.IpsecEncryption = this.IpsecEncryption;
            vpnclientIpsecPolicy.IpsecIntegrity = this.IpsecIntegrity;
            vpnclientIpsecPolicy.IkeEncryption = this.IkeEncryption;
            vpnclientIpsecPolicy.IkeIntegrity = this.IkeIntegrity;
            vpnclientIpsecPolicy.DhGroup = this.DhGroup;
            vpnclientIpsecPolicy.PfsGroup = this.PfsGroup;
